        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-3xl font-bold">
              Hello! My name is Aseel Khalid. If I am freelancing at some of Amman's finest digital agencies, I'm working remotely on projects for clients all over the world.
            </h1>
            <p className="py-6">
